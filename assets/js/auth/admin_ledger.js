...
function showPackageList(page_no) {
	$("#_package_list_tbl").html('<tr class="text-center"><td colspan="7">Getting package list...</td></tr>');
	$.ajax({
	...
	.done(function(res) {
		...
		for(var i in res.result) {
			...
			string += '<tr>'
                    ...
                    +'</td>'
                    +'<td>'
                        +'<span class="font-14">'+res.result[i].cost+'</span>'
                    +'</td>'
                    +'<td>'
                        +'<span class="font-14">'+res.result[i].direct_points+'</span>'
                    +'</td>'
                    +'<td>'
