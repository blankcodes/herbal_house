...
class Company extends CI_Controller {
  ...
  public function getSettingsWithdrawalLogs(){
    $row_no= $this->input->get('page_no');
    // Row per page
    $row_per_page = 10;
     // Row position
    ...
    // All records count
    $all_count = $this->my_account_model->getSettingsWithdrawalLogsCount();

    // Get records
    $products = $this->my_account_model->getSettingsWithdrawalLogs($row_per_page, $row_no);
