	...
	public function insertInDirectReferralCashBonus($sponsor_id, $referred_id, $packageData) {
		...
		if (!empty($gen1stData['sponsor_id'])) {
			...
			if (!empty($gen11thData['sponsor_id'])) {
				$this->insertWalletInDirectReferral($gen11thData['sponsor_id'], $packageData['indirect_points']);
			...
			if (!empty($gen12thData['sponsor_id'])) {
				$this->insertWalletInDirectReferral($gen12thData['sponsor_id'], $packageData['indirect_points']);
			...
			if (!empty($gen13thData['sponsor_id'])) {
				$this->insertWalletInDirectReferral($gen13thData['sponsor_id'], $packageData['indirect_points']);
			...
			if (!empty($gen14thData['sponsor_id'])) {
				$this->insertWalletInDirectReferral($gen14thData['sponsor_id'], $packageData['indirect_points']);
			...
			if (!empty($gen15thData['sponsor_id'])) {
				$this->insertWalletInDirectReferral($gen15thData['sponsor_id'], $packageData['indirect_points']);
			...
			if (!empty($gen16thData['sponsor_id'])) {
				$this->insertWalletInDirectReferral($gen16thData['sponsor_id'], $packageData['indirect_points']);
			...
			if (!empty($gen17thData['sponsor_id'])) {
				$this->insertWalletInDirectReferral($gen17thData['sponsor_id'], $packageData['indirect_points']);
			...
			if (!empty($gen18thData['sponsor_id'])) {
				$this->insertWalletInDirectReferral($gen18thData['sponsor_id'], $packageData['indirect_points']);
			...
			if (!empty($gen19thData['sponsor_id'])) {
				$this->insertWalletInDirectReferral($gen19thData['sponsor_id'], $packageData['indirect_points']);
			...
			if (!empty($gen20thData['sponsor_id'])) {
				$this->insertWalletInDirectReferral($gen20thData['sponsor_id'], $packageData['indirect_points']);
