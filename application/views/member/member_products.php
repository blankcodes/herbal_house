                    ...
                    <div class="container-fluid margin-top-20">
                        ...
                        <div id="" class="mt-2 mb-5">
                            <div class="mb-3">
                                <div class="alert alert-success  fade show c-black" role="alert">
                                    <i class="uil-exclamation-circle "></i> Get <span class="fw-700">Unilevel Points</span> and earn whenever someone use your Product link to buy products. Choose products and Click the <span class="fw-700">"Copy URL"</span> and share it to your friend or someone. You may use it to post on any social media websites or to your own website.
                                </div>
                            </div>
