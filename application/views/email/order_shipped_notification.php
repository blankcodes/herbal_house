...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<title>Order Shipped Notification - Herbal House Philippines</title>
											...
											<table width="100%" cellpadding="0" cellspacing="0" style="position: relative;">
												...
												<tr>
													<td data-color="text" data-size="size text" data-min="10" data-max="26" data-link-color="link text color" data-link-style="font-weight:bold; text-decoration:underline; color:#40aceb;"  style="font:normal 16px/26px Poppins, Helvetica, sans-serif; color:#363636; padding:0 0 20px;">
														...
														<div style="padding-bottom: 20px; padding-top: 25px; width: 400px; color: #363636; font-size: 14px; font-weight: 400;">
														...
														<div style="padding-bottom: 20px; color: #363636;">
															<table class="table-tx-body" style="font:normal 15px/20px Poppins,Helvetica,sans-serif;">
																<tr style="padding-bottom: 10px; width: 100%; font-family: Poppins;">
																	<td width="200">Courier.: </td>
																	<td width="200"><span ><?=$courier?></span></td>
																</tr>

																<tr style="padding-bottom: 10px; width: 100%; font-family: Poppins;">
																	<td width="200">Tracking #: </td>
																	<td width="200"><span ><?=$tracking_number?></span></td>
																</tr>
