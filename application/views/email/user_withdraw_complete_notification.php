...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<title>User Withdraw Complete - Herbal House Philippines</title>
												...
												<tr>
													<td data-color="text" data-size="size text" data-min="10" data-max="26" data-link-color="link text color" data-link-style="font-weight:bold; text-decoration:underline; color:#40aceb;"  style="font:normal 16px/26px Poppins, Helvetica, sans-serif; color:#363636; padding:0 0 20px;">
														...
														<div style="padding-bottom: 20px; padding-top: 25px; width: 400px; color: #363636; font-size: 14px; font-weight: 400;">
															This is to notify you that your withdrawal request with a reference # of <?=$reference_no?> amounting <?='₱'.$total_amount?> is now Complete!
														</div>
