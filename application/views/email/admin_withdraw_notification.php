...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<title>Withdrawal Notification - Herbal House Philippines</title>
											...
											<table width="100%" cellpadding="0" cellspacing="0" style="position: relative;">
												...
												<tr>
													<td data-color="text" data-size="size text" data-min="10" data-max="26" data-link-color="link text color" data-link-style="font-weight:bold; text-decoration:underline; color:#40aceb;"  style="font:normal 16px/26px Poppins, Helvetica, sans-serif; color:#363636; padding:0 0 20px;">
														...
														<div style="padding-bottom: 20px; padding-top: 15px; width: 400px; color: #363636; font-size: 14px; font-weight: 400;">This is to notify you that there's a New Withdrawal Request! Kindly check it <a href="https://herbalhouseph.com/withdraw-request">here</a>.</div>

														<b style=" font-size: 16px;  color: #363636; font-weight: 600;">Withdraw Details</b>
