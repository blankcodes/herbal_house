...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<title>Admin Order Notification - Herbal House Philippines</title>
											...
											<table width="100%" cellpadding="0" cellspacing="0" style="position: relative;">
												<tr>
													<td data-color="text" data-size="size text" data-min="10" data-max="26" data-link-color="link text color" style="color: #888; padding-bottom: 10px; font:normal 17px/25px Poppins, Helvetica, sans-serif; color: #000; font-weight: 600;">
														Hello <span style="text-transform: capitalize; color: #000;"><?=$name?></span>,
													</td>
												</tr>
												<tr>
													<td data-color="text" data-size="size text" data-min="10" data-max="26" data-link-color="link text color" data-link-style="font-weight:bold; text-decoration:underline; color:#40aceb;"  style="font:normal 16px/26px Poppins, Helvetica, sans-serif; color:#363636; padding:0 0 20px;">
														...
														<div style="padding-bottom: 20px; padding-top: 25px; width: 400px; color: #363636; font-size: 14px; font-weight: 500;">This is to notify you that there's a New order in your Store! Kindly process it as soon as possible!</div>

														<b style=" font-size: 16px;  color: #363636; font-weight: 600;">Order Details</b>
														<div style="padding-bottom: 20px; color: #363636;">
															<table class="table-tx-body" style="font:normal 15px/20px Poppins,Helvetica,sans-serif;">
																<tr style="padding-bottom: 10px; width: 100%; font-family: Poppins;">
																	<td width="200">Reference No.: </td>
																	<td width="200"><span ><?=$reference_no?></span></td>
																</tr>

																<tr style="padding-bottom: 10px; width: 100%; font-family: Poppins;">
																	<td width="200">Payment Method: </td>
																	<td width="200"><span ><?=$payment_method?></span></td>
																</tr>
																...
																<tr style="padding-bottom: 10px; width: 100%; font-family: Poppins;">
																	<td width="200">Date Ordered: </td>
																	<td width="200"><span ><?=$ordered_date?></span></td>
																</tr>
															</table>
														</div>

														<div style="padding-bottom:25px; text-align: center; padding-top: 15px;">
															<a href="<?=$order_details?>" style="border-radius: 10px; border: 1px solid #05cb62 ; background: #05cb62 ; color: #fff; padding: 13px 20px 13px 20px; text-decoration: none; font-size: 15px; font-weight: 500;">View Order</a>
														</div>
														...
														<table width="100%" cellpadding="0" cellspacing="0">
															<tr>
																<td data-color="text" data-link-color="link text color" data-link-style="text-decoration:underline; color:#797c82;" class="aligncenter" style="font:12px/16px Arial, Helvetica, sans-serif; color:#797c82; padding:0 0 10px;">
																	&copy; <?=date('Y')?> Herbal House. All Rights Reserved. 
																</td>
															</tr>
														</table>
													</th>
