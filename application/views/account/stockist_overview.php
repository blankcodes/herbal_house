                        ...
                        <div class="row mt-3">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Stockist / <?=$userDataOpt['fname'].' '.$userDataOpt['lname']?>'s Account</h4> 
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                    ...
                                    <div class="card">
                                        <div class="card-body ">
                                            <div class="alert alert-success bg-light text-dark border-0" role="alert">
                                                This is Stockist's monitoring and inventory dashboard. 
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <div class="bg-default text-dark border-0 mb-4" role="alert">
                                        List of transactions from the Stockist customer's purchase.
                                    </div>
